    ...
    return (
        <>
            <Form>
                ...
                <Row>
                    <Col >
                        <Form.Group className="mb-3" controlId="enable_image_lightbox">
                    ...
                    <Col >
                        ...
                        <Form.Group className="mb-3" controlId="show_price_button">
                    ...
                    <Col >
                        <Form.Group className="mb-3" controlId="show_formated_description">
                ...
                <Row>
                    <Col >
                        <Form.Group className="mb-3" controlId="hide_soldout_products">
                    ...
                    <Col >
                        ...
                        <Form.Group className="mb-3" controlId="show_message_when_adding_to_cart">
                    ...
                    <Col >
                        <Form.Group className="mb-3" controlId="add_button_text">
                ...
                <Row>
                    <Col >
                        <Form.Group className="mb-3" controlId="remember_selections">
                    ...
                    <Col >
                        ...
                        <Form.Group className="mb-3" controlId="show_image_carousels">
                    ...
                    <Col >
                        <Form.Group className="mb-3" controlId="show_step_progress">
